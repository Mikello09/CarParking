...
public class SQLHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table if not exists Coche (id integer primary key autoincrement, piso TEXT NOT NULL, plaza TEXT, color TEXT, foto TEXT, latitud TEXT, longitud TEXT); ";
    ...
    public void insertCoche(SQLiteDatabase db, String piso, String plaza, String color, String foto, String latitud, String longitud){
